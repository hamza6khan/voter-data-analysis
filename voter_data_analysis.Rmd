...
for(i in 1:nrow(CES)) {
  if (is.na(CES$no_vote[i])){
    CES$no_vote[i] = "NA"
  }
  else if (CES$no_vote[i] == 1){
    CES$no_vote[i] = "Forgot"
  }
  else if (CES$no_vote[i] == 2){
    CES$no_vote[i] = "Not interested"
  }
  else if (CES$no_vote[i] == 3){
    CES$no_vote[i] = "Too busy"
  }
  else if (CES$no_vote[i] == 4){
    CES$no_vote[i] = "Did not like candidates"
  }
  else if (CES$no_vote[i] == 5){
    CES$no_vote[i] = "Not Registered"
  }
  else if (CES$no_vote[i] == 6){
    CES$no_vote[i] = "Wrong form of ID"
  }
  else if (CES$no_vote[i] == 7){
    CES$no_vote[i] = "Out of town"
  }
  else if (CES$no_vote[i] == 8){
    CES$no_vote[i] = "Sick or disabled"
  }
  else if (CES$no_vote[i] == 9){
    CES$no_vote[i] = "Transportation"
  }
  else if (CES$no_vote[i] == 10){
    CES$no_vote[i] = "Bad weather"
  }
  else if (CES$no_vote[i] == 11){
    CES$no_vote[i] = "Line too long"
  }
  else if (CES$no_vote[i] == 12){
    CES$no_vote[i] = "Not allowed to vote"
  }
  else if (CES$no_vote[i] == 13){
    CES$no_vote[i] = "Didn't receive absentee ballot"
  }
  else if (CES$no_vote[i] == 14){
    CES$no_vote[i] = "Unsure of location"
  }
  else if (CES$no_vote[i] == 15){
    CES$no_vote[i] = "Lack of info on candidates"
  }
  else if (CES$no_vote[i] == 16){
    CES$no_vote[i] = "Fear of COVID Exposure"
  }
  else if (CES$no_vote[i] == 17){
    CES$no_vote[i] = "Other"
  }
  else if (CES$no_vote[i] == 55){
    CES$no_vote[i] = "Don't know"
  } 
}
...
```{r warning=FALSE}
ggplot(data = CES_no_vote_grouped, aes(no_vote, no_vote_count), !is.na(no_vote)) +
  #geom_bar() +
  geom_chicklet() +
